...
<html lang="en">
  ...
  <body>
	    ...
	    <div class = "container">
		    <form class="form-inline" method="GET" action="">
			  ...
			  <select class="custom-select my-1 mr-sm-2" id="bid" name="bid">
			    ...
			    <option value="8">KAJATI</option>
			    <option value="9">WAKAJATI</option>
			    <option value="1">PEMBINAAN</option>
			    <option value="2">INTELIJEN</option>
			    <option value="3">PIDANA UMUM</option>
			    <option value="4">PIDANA KHUSUS</option>
			    <option value="5">PERDATA DAN TATA USAHA NEGARA</option>
			    <option value="6">PENGAWASAN</option>
            ...
            <div class = "card">
              <div class = "card-body">
                <h5 class = "card-title text-center">
                	<?php 
			    		if ($bid=='1') {
			    			echo "BIDANG PEMBINAAN";
			    		}elseif ($bid=='2') {
			    			echo "BIDANG INTELIJEN";
			    		}elseif ($bid=='3') {
			    			echo "BIDANG PIDANA UMUM";
			    		}elseif ($bid=='4') {
			    			echo "BIDANG PIDANA KHUSUS";
			    		}elseif ($bid=='5') {
			    			echo "BIDANG PERDATA DAN TATA USAHA NEGARA";
			    		}elseif ($bid=='6') {
			    			echo "BIDANG PENGAWASAN";
			    		}elseif ($bid=='7') {
			    			echo "BIDANG TATA USAHA";
			    		}elseif ($bid=='8') {
			    			echo "KAJATI";
			    		}elseif ($bid=='9') {
			    			echo "WAKAJATI";
	...
	<script>
	var kajati = document.getElementById('MyChart').getContext('2d');
