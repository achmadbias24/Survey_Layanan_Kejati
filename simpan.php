...
if(isset($keterangan)){
	...
	if($keterangan == "sangat_puas")
	{
		...
		$query = "INSERT INTO survey values ('','$bidang','$date','SANGAT PUAS')";
	}
	elseif($keterangan == "puas")
	{
		
		//query masukkan tanggapan puas
		$query = "INSERT INTO survey values ('','$bidang','$date','PUAS')";
	}
	elseif($keterangan == "kurang")
	{
		//query masukkan tanggapan kurang puas
		$query = "INSERT INTO survey values ('','$bidang','$date','KURANG PUAS')";
	}
